...
//   // Organic "blob" border-radius variants — used instead of rectangular cards
//   const blobShapes = [
...
//       <section
//         ref={sectionRef}
//         className="relative overflow-hidden bg-white py-28 border-t border-slate-200/50"
//       >
...
//             <div
//               className={`relative rounded-[45%_55%_65%_35%/40%_45%_55%_60%] border border-slate-200 bg-white p-10 shadow-sm transition-all duration-700 hover:shadow-xl hover:rounded-[35%_65%_55%_45%/50%_35%_65%_50%] ${
//                 isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//               }`}
//               style={{ transitionDelay: "0ms" }}
//             >
//               <div className="flex h-16 w-16 items-center justify-center rounded-[60%_40%_30%_70%/50%_60%_40%_50%] bg-gradient-to-br from-blue-50 to-teal-50 text-3xl">
//                 👁️
//               </div>
//               <h3 className="mt-6 text-xl font-bold text-slate-800">Our Vision</h3>
//               <p className="mt-3 text-slate-600 leading-relaxed">
//                 A prosperous, inclusive, and empowered society where every youth, woman, 
//                 orphan, and vulnerable child has equal opportunities to thrive and contribute 
//                 to sustainable national development.
...
//             <div
//               className={`relative rounded-[55%_45%_35%_65%/60%_55%_45%_40%] border border-slate-200 bg-white p-10 shadow-sm transition-all duration-700 hover:shadow-xl hover:rounded-[65%_35%_45%_55%/45%_60%_40%_55%] ${
//                 isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//               }`}
//               style={{ transitionDelay: "100ms" }}
//             >
//               <div className="flex h-16 w-16 items-center justify-center rounded-[40%_60%_70%_30%/50%_40%_60%_50%] bg-gradient-to-br from-teal-50 to-emerald-50 text-3xl">
//                 🎯
//               </div>
//               <h3 className="mt-6 text-xl font-bold text-slate-800">Our Mission</h3>
//               <p className="mt-3 text-slate-600 leading-relaxed">
//                 To empower vulnerable youth, women, orphans, and street-connected children 
//                 through education, skills development, economic empowerment, child protection, 
//                 healthcare, environmental conservation, and strategic partnerships.
...
//                 <span
//                   key={i}
//                   className={`px-4 py-2 text-sm font-medium text-slate-700 bg-slate-100 hover:bg-teal-50 hover:text-teal-700 transition-colors ${
//                     i % 2 === 0
...
//         <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
//           <div className="text-center max-w-3xl mx-auto">
//             <span className="inline-block rounded-[50%_50%_40%_60%/60%_40%_50%_50%] bg-teal-50 px-4 py-1.5 text-sm font-semibold text-teal-700">
//               Our Programmes
//             </span>
//             <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-800 sm:text-4xl">
//               What We Do
...
//               <div
//                 key={i}
//                 className={`group relative bg-white p-8 shadow-sm border border-slate-200 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 ${
...
//                 style={{ transitionDelay: `${i * 100}ms` }}
//               >
//                 <div className="flex h-16 w-16 items-center justify-center rounded-[60%_40%_40%_60%/40%_60%_40%_60%] bg-teal-50 text-3xl transition-transform duration-500 group-hover:scale-110">
//                   {programme.icon}
//                 </div>
...
//             <div className="relative rounded-[45%_55%_60%_40%/40%_45%_55%_60%] bg-teal-700 p-10 text-white overflow-hidden">
...
//               <Link
//                 href="/contact"
//                 className="relative mt-8 inline-block rounded-[50%_50%_40%_60%/60%_40%_50%_50%] bg-white px-7 py-3 font-medium text-teal-700 transition hover:bg-teal-50"
//               >
//                 Contact Us Today →
//               </Link>
//             </div>
...
//               <div
//                 key={i}
//                 className={`flex flex-col items-center justify-center text-center p-6 aspect-square bg-white/[0.03] border border-white/10 transition-colors hover:bg-white/[0.06] ${
//                   blobShapes[i % blobShapes.length]
//                 }`}
//               >
//                 <p className="text-3xl sm:text-4xl font-bold text-teal-400">{stat.number}</p>
...
//             <Link
//               href="mailto:info@hkmf.org"
//               className="rounded-[50%_50%_40%_60%/60%_40%_50%_50%] bg-teal-600 px-8 py-3.5 font-medium text-white transition hover:bg-teal-700 hover:shadow-lg"
//             >
//               Email Us
//             </Link>
//             <Link
//               href="/about"
//               className="rounded-[50%_50%_40%_60%/60%_40%_50%_50%] border border-slate-300 px-8 py-3.5 font-medium text-slate-700 transition hover:bg-slate-50"
//             >
//               Learn More
//             </Link>
//           </div>
...
export default function Home() {
  ...
  // Organic "blob" border-radius variants for larger cards — gentler curve
  // range (35–65%) than before so text has room to breathe inside the shape
  const blobShapes = [
    "rounded-[38%_62%_34%_66%/45%_38%_62%_55%]",
  ...
  // Squircle mix for small elements (pills, buttons, stat boxes) — fixed
  // corner radii instead of percentages, since percentage blobs cut too
  // deep into small elements no matter how much padding you add
  const softShapes = [
