        ...
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Kyobe Muhamad Foundation (KMF) was established to improve the quality 
        ...
        <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
              KMF is built on the belief that empowered people create stronger communities. 
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-4 text-lg text-slate-600 leading-relaxed">
                Kyobe Muhamad Foundation was founded by a passionate community leader 
              ...
              <div className="mt-6 space-y-4 text-slate-600">
                <p className="leading-relaxed">
                  ...
                  established KMF with a clear vision: to create lasting change in communities 
        ...
        <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-lg text-slate-600">
              These principles guide everything we do at KMF.
            </p>
          </div>
...
<section className="relative bg-slate-50/50 py-20 border-t border-slate-200/50">
  ...
  <div className="relative mx-auto max-w-4xl px-5 text-center lg:px-8">
    ...
    <p className="mt-3 text-slate-600 max-w-2xl mx-auto">
      Kyobe Muhamad Foundation (KMF) is a legally registered Community-Based Organization (CBO) in Uganda, operating under approved governing documents.
    </p>
