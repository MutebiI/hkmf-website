...
//   const handleDonate = () => {
//     if (selectedAmount) {
//       const link = paymentLinks[selectedAmount as keyof typeof paymentLinks];
//       if (link) {
...
//     window.open(paymentLinks.custom, "_blank");
//   };
...
//             alt="Give Today - Support Kyobe Muhamad Foundation"
//             fill
//             className="object-cover"
//             priority
//           />
//           <div className="absolute inset-0 bg-gradient-to-b from-teal-900/85 via-teal-800/75 to-teal-700/85" />
...
//                 <span className="text-3xl font-bold text-white">KMF</span>
//               </div>
//             </div>
...
//             {/* Donate Button for Preset Amounts */}
//             <button
...
//                 className="w-full rounded-full border-2 border-red-500 px-8 py-4 font-semibold text-red-600 transition-all hover:bg-red-50 hover:shadow-lg"
//               >
//                 🔴 Click here to donate a custom amount of your choice
//               </button>
//               <p className="mt-2 text-center text-xs text-slate-400">
//                 Minimum custom amount: 50,000 UGX ($14)
//               </p>
//             </div>
      ...
      <section className="py-16 bg-slate-50/50">
        <div className="mx-auto max-w-3xl px-5 lg:px-8">
          <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-4">
              {currentAmounts.map((amount) => (
                <button
                  ...
                  className={`py-4 px-4 rounded-xl border-2 font-semibold text-base transition-all ${
                    selectedAmount === amount.value
                      ? "border-teal-600 bg-teal-50 text-teal-700 shadow-sm"
                      : "border-slate-300 bg-white text-slate-800 hover:border-teal-300 hover:bg-teal-50/50 hover:shadow-sm"
                  }`}
                >
                  {amount.label}
                </button>
            ...
            {/* Impact Display */}
            {selectedAmount && (
              <div className="mt-5 p-4 rounded-xl bg-teal-50 border border-teal-200/50">
                <p className="text-sm text-teal-700">
                  <span className="font-semibold">Your impact:</span>{" "}
                  {currentAmounts.find((a) => a.value === selectedAmount)?.impact}
                </p>
