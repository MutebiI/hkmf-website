...
//                   <p className="text-slate-600">mailto:info@kyobemuhammadfoundation.org</p>
//                 </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div>
                  <h3 className="font-semibold text-slate-800">📧 Email</h3>
                  <a href="mailto:info@kyobemuhammadfoundation.org" className="text-slate-600 hover:text-teal-600 transition">
                ...
                <div>
                  <h3 className="font-semibold text-slate-800">📞 Phone</h3>
                  <a href="tel:+256701481024" className="text-slate-600 hover:text-teal-600 transition">
                    +256 701 481 024
                  </a>
                </div>
